...
import (
	...
	"github.com/kfngp/gser/framework/gin/internal/bytesconv"
...
type Engine struct {
	// container is the center of service providers
...
func (engine *Engine) Run(addr ...string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://pkg.go.dev/github.com/kfngp/gser/framework/gin#readme-don-t-trust-all-proxies for details.")
	}
