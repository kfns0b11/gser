...
type IRequest interface {
	QueryInt(key string, defaultValue int) (int, bool)
	QueryInt64(key string, defaultValue int64) (int64 bool)
	QueryFloat64(key string, defaultValue float64) (float64 bool)
	QueryBool(key string, defaultValue bool) (bool bool)
	QueryString(key string, defaultValue bool) (string bool)
	QueryStringSlice(key string, defaultValue []string) ([]string, bool)
	Query(key string) interface{}

	ParamInt(key string, defaultValue int) (int, bool)
	ParamInt64(key string, defaultValue int64) (int64, bool)
	ParamFloat64(key string, defaultValue float64) (float64, bool)
	ParamFloat32(key string, defaultValue float32) (float32, bool)
	ParamBool(key string, defaultValue bool) (bool, bool)
	ParamString(key string, defaultValue string) (string, bool)
	Param(key string) interface{}

	FromInt(key string, defaultValue int) (int, bool)
	FormInt64(key string, defaultValue int64) (int, bool)
...
func (ctx *Context) QueryInt(key string, defaultValue int) (int, bool) {
	params := ctx.QueryAll()
...
func (ctx *Context) QueryInt64(key string, defaultValue int64) (int64, bool) {
	params := ctx.QueryAll()
	if vals, ok := params[key]; ok {
		len := len(vals)
		if len > 0 {
...
func (ctx *Context) ParamInt(key string, defaultValue int) (int, bool) {
...
func (ctx *Context) FormAll() map[string][]string {
	if ctx.request != nil {
		ctx.request.ParseForm() //nolint: errcheck
		return map[string][]string(ctx.request.PostForm)
	}
	return nil
}

func (ctx *Context) FormInt64(key string, defaultValue int64) (int64, bool) {
	params := ctx.FormAll()
	if vals, ok := params[key]; ok {
		if len(vals) > 0 {
			return cast.ToInt64(vals[0]), true
