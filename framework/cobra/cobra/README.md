...
Install the cobra generator with the command `go install github.com/kfngp/gser/framework/cobra/cobra`. 
...
Cobra init can also be run from a subdirectory such as how the [cobra generator itself is organized](https://github.com/kfngp/gser/framework/cobra).
...
For complete details on using the Cobra library, please read the [The Cobra User Guide](https://github.com/kfngp/gser/framework/cobra/blob/master/user_guide.md#using-the-cobra-library).
